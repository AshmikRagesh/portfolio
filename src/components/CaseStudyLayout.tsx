...
export default function CaseStudyLayout({
  ...
  return (
    <>
    <div className="flex min-h-screen pt-[96px]">

      {/* ── Sticky sidebar (desktop only) ── */}
      <aside className="hidden lg:flex flex-col w-[260px] xl:w-[300px] shrink-0 sticky top-[96px] self-start h-[calc(100vh-96px)] pl-[100px] pr-8 py-10 overflow-y-auto">
        {/* Back button */}
        <Link
          href={backHref}
      ...
      <main className="flex-1 min-w-0">
        ...
        <div className="lg:hidden sticky top-[96px] z-30 bg-white border-b border-[#e8eaed]">
